...
Minimum supported version is Laravel 10
...
```
composer require tinovn/laravel-pdf
```
...
'providers' => [
	// ...
	tinovn\LaravelPdf\Providers\PdfServiceProvider::class
]
```
...
'aliases' => [
	// ...
	'PDF' => tinovn\LaravelPdf\Facades\Pdf::class
]
```
...
return [
    // ...
    'pdfWrapper' => 'tinovn\LaravelPdf\Wrapper\PdfWrapper',
];
```

The only requirement that the wrapper must implement the interface
`tinovn\LaravelPdf\PdfInterface\PdfWrapperInterface`
